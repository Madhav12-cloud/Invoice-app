...
import { createBusinessProfile, getMyBusinesProfile, updateBusinessProfile, deleteBusinesProfile } from '../controllers/businessProfileController.js';
...
businessProfileRouter.get("/me", getMyBusinesProfile);
businessProfileRouter.delete("/", deleteBusinesProfile);
