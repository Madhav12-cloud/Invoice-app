...
export default function Hero() {
  ...
  const handleSignedInPrimary = async () => {
  try {
    ...
    console.log("HERO PLAN:", data.plan);

    if (data.plan) {
      navigate("/app"); // existing user
    } else {
      navigate("/pricing"); // new user
    }
  ...
  //   navigate("/pricing"/*"/app/create-invoice"*/);
  // };
